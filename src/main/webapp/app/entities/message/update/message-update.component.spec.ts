...
describe('Message Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const sender: IUser = { id: 19399 };
      message.sender = sender;

      const userCollection: IUser[] = [{ id: 813 }];
    ...
    it('Should call ChatRoom query and add missing value', () => {
      const message: IMessage = { id: 456 };
      const room: IChatRoom = { id: 6467 };
      message.room = room;

      const chatRoomCollection: IChatRoom[] = [{ id: 985 }];
    ...
    it('Should update editForm', () => {
      const message: IMessage = { id: 456 };
      const sender: IUser = { id: 29034 };
      message.sender = sender;
      const room: IChatRoom = { id: 20800 };
      message.room = room;
